...
export class PostImagesService {
    ...
    getRepository(queryRunner?: QueryRunner){
        return queryRunner ? queryRunner.manager.getRepository<ImagesModel>(ImagesModel) : this.imagesRepository;
    }

    async createPostImage(dto: CreatePostImageDto, queryRunner?: QueryRunner): Promise<ImagesModel> {
